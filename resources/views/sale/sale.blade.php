                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input name="purchaseId" type="text" class="form-control invoice-edit-input" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class=" mt-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <div style="width: 11.21rem; max-width:11.21rem; " class="align-items-center">
                                                <input onkeyup="getCustomerById()" id="customer_id" class="form-control" placeholder="ID" type="text">
                                            </div>
                                        </div>
                                        <div class="mt-1 d-flex align-items-center justify-content-between">
                                            <span class="title">Customer Name:</span>
                                            <div style="width: 11.21rem; max-width:11.21rem; " class="align-items-center">
                                                <input onkeyup="getByName()" id="customer_name" class="form-control" placeholder="Customer Name" type="text">
                                                ...
                                                <div class="col-12  product-details-border position-relative pe-0">
                                                    <div class="row py-2">
                                                        <div class="col-1 my-lg-0 my-2">
                                                            ...
                                                            <input disabled id="item_id" name="amount" type="number" class="form-control" value="" placeholder="id">
                                                        </div>
                                                        <div class="col-3 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Item Name</p>
                                                            <input onkeyup="getItems()" id="item_name" name="amount" type="text" class="form-control" placeholder="Item Name">
                                                        ...
                                                        <div class="col-2 my-lg-0 my-2">
                                                            ...
                                                            <input onkeyup="calculateInstallments()" id="selling_price" name="amount" type="number" class="form-control" value="" placeholder="Selling Price">
                                                        </div>
                                                        <div class="col-2 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Plan (Months)</p>
                                                            <input onkeyup="calculateInstallments()" id="plan" name="amount" type="number" class="form-control" value="" placeholder="Months">
                                                        </div>
                                                        <div class="col-2 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">MarkUp</p>
                                                            <input onkeyup="calculateInstallments()" id="markup" name="amount" type="number" class="form-control" value="" placeholder="%">
                                                        </div>
                                                    </div><s></s>
                                            ...
                                            <div class="row mt-1">
                                                <div class="col-lg-5 col-12 mt-lg-0 mt-2">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="hidden" id="total_sum" style=" border: none;background-color: transparent;resize: none;outline: none;" name="total_sum" class="form-control" value="0 PKR" disabled>
                                            ...
                                            <div class="row ">
                                                <div class="col-lg-5 col-12 mt-lg-0 mt-2">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="hidden" id="down_payment" style=" border: none;background-color: transparent;resize: none;outline: none;" name="down_payment" class="form-control" value="0 PKR" disabled>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5 col-12 mt-lg-0 mt-2">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="hidden" id="instalments" style=" border: none;background-color: transparent;resize: none;outline: none;" name="down_payment" class="form-control" value="0 PKR" disabled>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-12 mt-lg-0 mt-2">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="hidden" id="per_month" style=" border: none;background-color: transparent;resize: none;outline: none;" name="down_payment" class="form-control" value="0 PKR" disabled>
