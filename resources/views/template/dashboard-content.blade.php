        ...
        <section id="dashboard-ecommerce">
            ...
            <div class=" card-statistics">
                ...
                <div class="card-body statistics-body">
                    <div class="row">
                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0 card card p-2 me-2 p-2 me-2 ">
                        ...
                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0 card card p-2 me-2 p-2">
                            <div class="d-flex flex-row">
                        ...
                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0   card p-2 me-2 ">
                          <div class="d-flex flex-row">
                                <div class="avatar bg-light-primary me-2">
                                    <div class="avatar-content">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up avatar-icon">
                        ...
                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0 mt-1 card p-2 me-2">
                            <div class="d-flex flex-row">
                                <div class="avatar bg-light-primary me-2">
                                    <div class="avatar-content">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up avatar-icon">
