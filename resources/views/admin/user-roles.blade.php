                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex ">
                                <div>
                                    <h4 class="text-center">Assign Roles to User</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <form method="POST" class="form form-vertical" autocomplete="on"
                                        action="{{ route('store-user-roles') }}">
                                        {{-- <div class="col-6">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <select class="mt-2 form-control" name="role" id="">
                                                @foreach ($roles as $r)
                                        ...
                                        <td>
                                            <div class="">
                                                <form class="" method="POST" autocomplete="on"
                                                    action="{{route('unassign-user-roles')}}">
                                                    @csrf
                                                    <input name="user_id" type="hidden" value="`+ roleId+`">
                                                    <input name="role_id" type="hidden" value="`+item.id +`">
                                                    <button
