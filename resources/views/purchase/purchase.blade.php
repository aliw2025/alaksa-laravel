                                                    ...
                                                    <div class="row   py-2">
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <input type="hidden" id="passId" name="itemId"
                                                                value="">
                                                            <input id="itemBox" class=" form-control" autocomplete="off"
                                                                placeholder="Enter Item" onkeyup="getItems(0)">
                                                            <div id="list" style="position: absolute; z-index: 1;"
                                                                class="card mb-4">
                ...
                var maarkup = `<div id="row${rowId}" class="row">
                                     <div class="mt-3 col-12 d-flex product-details-border position-relative pe-0">
                                        <div class="row py-2">
                                             <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                <p class="card-text col-title mb-md-2 mb-0">Item Id</p>
                                                <input type="number" class="form-control" value="" placeholder="" disabled>
                                                </div>
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <div id="list${rowId}" style="position: absolute; z-index: 1;"
                                                                class="card mb-4">
