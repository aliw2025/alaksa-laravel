                                ...
                                <div class="invoice-number-date mt-md-0 mt-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div style="width: 11.21rem; max-width:11.21rem; " class="align-items-center">
                                            <select class=" select2 select2-hidden-accessible form-control invoice-edit-input" id="select2-basic" data-select2-id="select2-basic" tabindex="-1" aria-hidden="true">
                                                @foreach ($investors as $investor)
                                                <option value="{{ $investor->id }}">{{ $investor->prefix }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                ...
                                                <div class="row py-2">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <input type="hidden" id="passId" name="itemId" value="">
                                                        <input autocomplete="off" id="itemBox0" class=" form-control" autocomplete="off" placeholder="Enter Item" onkeyup="getItems(0)">
                                                    ...
                                                    <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                        ...
                                                        <input onkeyup="calRowTotal(0)" id="cost0" name="cost[]" type="number" class="form-control" value="" placeholder="">
                                                    </div>
                                                    <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                        <p class="card-text col-title mb-md-2 mb-0">Qty</p>
                                                        <input pattern="[0-9]{10}" onkeyup="calRowTotal(0)" id="qty0" name="qty[]" type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" class="form-control" value="" placeholder="">
                                                    </div>
                                                    <!-- style="background-color: pink;" -->
                                                    <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                        <p class="card-text col-title mb-md-50 mb-0">Total</p>
                                                        <input style=" border: none;background-color: transparent;resize: none;outline: none;" id="rowTotal0" name="rowTotal[]" class="form-control" value="PKR 0" disabled>
        ...
        var maarkup = `<div id="row${rowId}" class="row">
                                     <div class="mt-3 col-12 d-flex product-details-border position-relative pe-0">
                                        <div class="row py-2">
                                             <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                <p class="card-text col-title mb-md-2 mb-0">Item Id</p>
                                                <input id ="passId${rowId}" type="number" class="form-control" value="" placeholder="" disabled>
                                                </div>
                                                        <div class="col-3">
                                                            <p class="card-text col-title mb-md-2 mb-0">Item Name</p>
                                                            <input type="hidden" id="passId" name="itemId"
                                                                value="">
                                                        ...
                                                        <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                            <p class="card-text col-title mb-md-50 mb-0">Total</p>
                                                            <input style=" border: none;background-color: transparent;resize: none;outline: none;" id="rowTotal${rowId}"  name="rowTotal[]"  class="form-control" value="PKR 0" disabled>
                                                        </div>
                                                    </div>
                                                    <div
