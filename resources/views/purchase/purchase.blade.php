                                                    ...
                                                    <div class="row   py-2">
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <input type="hidden" id="passId" name="itemId"
                                                                value="">
                                                            <input autocomplete="off" id="itemBox0" class=" form-control"
                                                                autocomplete="off" placeholder="Enter Item"
                                                                onkeyup="getItems(0)">
                                        ...
                                        <div class="row py-2">
                                             <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                ...
                                                <input id ="passId${rowId}" type="number" class="form-control" value="" placeholder="" disabled>
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Cost</p>
                                                            <input onkeyup="calRowTotal(${rowId})" id="cost${rowId}" name="cost[]" type="number" class="form-control" value="1"
                                                                placeholder="1">
                                                        </div>
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            <p class="card-text col-title mb-md-2 mb-0">Qty</p>
                                                            <input onkeyup="calRowTotal(${rowId})" id="qty${rowId}" name="qty[]" type="number" class="form-control" value="1"
                                                                placeholder="1">
                                                        </div>
                                                        
                                                        <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                            <p class="card-text col-title mb-md-50 mb-0">Total</p>
                                                            <p id="rowTotal${rowId}" class="card-text mb-0">PKR 24.00</p>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="d-flex flex-column align-items-center justify-content-between border-start invoice-product-actions py-50 px-25">
