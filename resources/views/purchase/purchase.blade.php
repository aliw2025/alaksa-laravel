        ...
        <section class="invoice-add-wrapper">
            <div class="row invoice-add">
                                        ...
                                        <div class="row">
                                            <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                    <div style="width: 15.21rem; max-width:15.21rem; " class="align-items-center">
                ...
                <div class="col-xl-3 col-md-4 col-12">
                    <div class="card">
                        <div class="card-body">
                            <button class="btn btn-primary w-100 mb-75 waves-effect waves-float waves-light" disabled="">Save</button>
                        ...
                        <div class="modal-body flex-grow-1">
                            <form>
                                ...
                                <div class="mb-1 position-relative">
                                    ...
                                    <select class="form-select select2-hidden-accessible" id="customer-country" name="customer-country" data-select2-id="customer-country" tabindex="-1" aria-hidden="true">
                                    ...
                                    </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="1" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-customer-country-container"><span class="select2-selection__rendered" id="select2-customer-country-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Select
                                ...
                                <div class="mb-1 d-flex flex-wrap mt-2">
                                    <button type="button" class="btn btn-primary me-1 waves-effect waves-float waves-light" data-bs-dismiss="modal">Add</button>
