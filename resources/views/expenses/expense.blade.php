                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        ...
                                        <div class="mt-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <div style="width: 11.21rem; max-width:11.21rem; " class="align-items-center">
                                                ...
                                                <select name="head_id" class=" select2 select2-hidden-accessible form-control invoice-edit-input" id="head_id" data-select2-id="select2-basic" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="mt-1 d-flex align-items-center justify-content-between">
                                            ...
                                            <div style="width: 11.21rem; max-width:11.21rem; " class="align-items-center">
                                                ...
                                                <select name="sub_head_id" class="form-control" id="shead_id" aria-hidden="true">
                                                    @if(isset($expense))
                                                    <option value="{{ $expense->head_id }}">
