...
Route::controller(InstalmentController::class)->prefix('instalment')->group(function () {
        ...
        Route::post('/pay-instalment-new-store', 'payInstalmentNewStore')->name('pay-instalment-new-store');
        Route::put('/pay-instalment-new/{id}', 'payInstalmentNewUpdate')->name('pay-instalment-new-update');
        ...
        Route::get('/instalment-payment-report-post', 'InstalmentPaymentReportPost')->name('instalment-payment-report-post');
